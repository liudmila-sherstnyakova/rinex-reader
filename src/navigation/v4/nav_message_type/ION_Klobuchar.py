...
class IONKlobNavRecordData:
    def __init__(self):
        ...
        self.region_code: float = 0.0


class IONKlobNavRecord:
    ...
    epoch_line_format = np.dtype([
        ...
        ('Alpha0', np.float64), ('Alpha1', np.float64), ('Alpha2', np.float64)
    ])
    ...
    def __init__(self, sv: str):
        ...
        self.message_line = IONKlobNavRecordData()
